...
'2.10.5' => ' 15/06/2013
- [Bugs]
#10337: Bug que no mostraba correctamente el tiempo de conexi�n en la alianza (By Think).-
#10530: Agregado texto faltante "Campos" en el overview.- 
#10340: Bug donde la formula de la planta de fusi�n no funcionaba correctamente.-
#10322: Bug en el overview con la informaci�n de las flotas.-
#10314: Bug en galaxia que mostraba a uno mismo como un jugador d�bil o fuerte.-
#10313: Bug en la galaxia pone "done" aunque haya un error al enviar la flota.-
#10718: Bug que no inclu�a la producci�n b�sica a la producci�n actual en la vista del imperio (By pele87).-
#10730: Bug en la b�squeda donde en tag de la alianza no redireccionaba correctamente a la info page de la alianza (By Loucouss).-
#10731: Bug que permit�a atacar a los administradores, aunque la opci�n estuviera bloqueada (By pele87).-
#10752: Bug en el tooltip de flotas y mostraba mal el tiempo de retorno en la p�gina de flotas (By jstar).-
#10794: Bug en las alianzas que no le daba correctamente permisos al administrador de la misma (By Think).-
#10799: Bug en la protecci�n de novatos. El jugador fuerte no era calculado correctamente (By Razican).-
#10895: Bug en plugins.php causaba un Warning (By Razican).-
#10908: Bug que permit�a ver los acs de otros jugadores e incluso unirse a los mismos (By quaua).-
-- [Nueva numeraci�n]
#00001: Bug en el mensaje js del mercader.-
#00003: Bug en el mensaje de los misiles interplanetarios que no llegan.-
#00004: Bug en la actualizaci�n de producci�n, con lo cual la misma era duplicada (By Think).-
',

'2.10.4' => ' 06/08/2012
- [Mejoras]
#10213: Agregada separaci�n en los textos del bloque de alianzas en la galaxia (By LordPretender).-

- [Cambio]
#10171: Cambiado el texto de contra espionaje (Como el OGame original).-

- [Optimizaci�n]
#10245: Eliminado c�digo redundante en class.CheckSession (By LordPretender).-
#10195: Eliminado c�digo redundante en Overview del admin (By Razican).-
#10141: Se realizaba una query innecesaria al visualizar la p�gina de recursos (By Think).-
#10115: Eliminada llamada a JS no v�lida al cargar la p�gina.-
#10097: Reducci�n m�nima de carga global al traer los datos del usuario (By Think).-
...
#10073: $InLogin no est� definido excepto en el login y el registro (By Razican).-

- [Bugs]
#10250: Corregido un bug que no mostraba la informaci�n de los misiles en el info (By Think).- 
#10240: Corregido un bug de cookies que ocurr�a en algunas circunstancias (By Razican).-
#10233: Corregido un bug que intentaba mostrar una imagen para un planeta destruido (By Think).-
#10228: Bug que permit�a escribir un tag en la alianza menor a 3 caracteres (By Think).-
#10215: Algunos textos solo se mostraban en espa�ol (By LordPretender).-
#10203: Reemplazado eregi_replace por preg_replace en class.FlyingFleetsTable (By Razican).-
#10201: No se inclu�an correctamente algunos archivos en la p�gina del phalanx (By JonaMix).-
#10197: Corregida la formula de calculo de coste de energ�a para la planta de fusi�n (By Think).-
#10196: Solucionado un bug en la protecci�n de novatos (By LordPretender).-
...
#10132: Bug que a�ad�a una fila extra en el showinfos del salto cuantico (By Razican).-
#10129: Bug que permit�a ver la informaci�n de elementos inexistentes en class.ShowInfosPage.php (By Razican).-
...
#10099: Eliminadas l�neas de lenguaje que no ten�an utilidad (By Razican).-
#10096: En ciertas circunstancias al intentar cerrar la conexi�n con la db se produc�a un error en la p�gina de notas (By Razican).-
#10093: Resultados repetidos en la b�squeda (By Think).-
...
#10084: No se especificaba en el historial si alguna configuraci�n se hab�a activado o no (By Think y Razican).-
...
#9968: Problemas con los saltos de l�nea en la alianza y las notas (By Borboco).-
#9926: Bug en la cola de construcci�n (By Think).-
',
...
- Volvimos a implementar el leftmenu antig�o, funciona m&aacute;s r&aacute;pido.-
